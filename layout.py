...
SHARED_CSS = """
  ...
  * { box-sizing: border-box; }
  ...
  .stat { flex: 1; min-width: 0; background: transparent; padding: 22px 16px; text-align: center; border-top: 3px solid transparent; border-right: 1px solid rgba(255,255,255,0.12); }
  ...
  .stat .num { font-family: "Space Grotesk", sans-serif; font-size: 1.05rem; font-weight: 700; color: #fff; }
  .stat .lbl { font-size: 0.72rem; color: rgba(255,255,255,0.6); text-transform: uppercase; letter-spacing: 0.05em; margin-top: 3px; font-weight: 500; }
  @media (max-width: 760px) { .stats { flex-wrap: wrap; margin: -20px 16px 0; } .stat { flex: 1 1 40%; border-right: none; border-bottom: 1px solid rgba(255,255,255,0.12); } .hero { padding: 48px 20px 40px; } }
  ...
  .feature-band .ql-icon { color: #7dd3fc; filter: drop-shadow(0 0 6px rgba(56,189,248,0.55)); }
  .feature-band .ql-title { color: #f5f8ff; }
  .feature-band .ql-desc { color: #9fb0d0; }
  .feature-band .ql-cta { color: #5fd0ff; }
